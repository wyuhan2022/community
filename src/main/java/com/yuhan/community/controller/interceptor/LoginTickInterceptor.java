package com.yuhan.community.controller.interceptor;
...
import com.yuhan.community.util.CookieUtil;
 ...
 */
@Component
public class LoginTickInterceptor implements HandlerInterceptor {
    @Autowired
